...
namespace SSXImport.Business
{
	...
	public abstract class MultiCriterion : ICriterion
	{
		...
		public virtual List<List<ICriterion>> GroupRestrictions { get; set; }
		public abstract IDataCriterion DataCriterion();
		public abstract object Clone();
	}
	...
	public class OrCriterion : MultiCriterion
	{
		public override object Clone()
		{
			return new OrCriterion() { Restrictions = this.Restrictions, GroupRestrictions = this.GroupRestrictions };
		}

		public override IDataCriterion DataCriterion()
		{
			List<IDataCriterion> lst = new List<IDataCriterion>();
			List<List<IDataCriterion>> grpList = new List<List<IDataCriterion>>();
			foreach (Criterion criterion in this.Restrictions)
				lst.Add(criterion.DataCriterion());
			
			foreach (List<ICriterion> lstCriterion in this.GroupRestrictions)
			{
				List <IDataCriterion> grp = new List<IDataCriterion>();
				foreach (var crit in lstCriterion)
					grp.Add(crit.DataCriterion());
				grpList.Add(grp);
			}
			return (IDataCriterion)new DataCriterionOr() { List = lst, GroupList = grpList };
		}
	}
