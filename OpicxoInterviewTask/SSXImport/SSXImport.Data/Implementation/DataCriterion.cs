...
namespace SSXImport.Data
{
	...
	public partial class DataMultiCriterion
	{
		...
		public virtual List<List<IDataCriterion>> GroupList { get; set; }
	}
	...
	public class DataCriterionOr : DataMultiCriterion, IDataCriterion
	{
		public string ToSql()
		{
			...
			foreach (var grp in GroupList)
			{
				ret += (ret == "") ? "" : " OR ";
				string grpTxt = "";
				foreach (var grpCondition in grp)
				{
					grpTxt += (grpTxt == "") ? "" : " AND ";
					grpTxt += grpCondition.ToSql();
				}
				if (!string.IsNullOrEmpty(grpTxt)) grpTxt = "(" + grpTxt + ")";
					ret += grpTxt;
			}
			return ret;
		}
